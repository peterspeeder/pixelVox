...
@njit
def to_uint(x, y, z, voxel_id, face_id, ao_id):
        ...
        for y in range(CHUNK_SIZE):
            for z in range(CHUNK_SIZE):
                ...
                if is_void((x, y + 1, z), (wx, wy + 1, wz), world_voxels):
                    ...
                    v0 = to_uint(x,     y + 1, z,     voxel_id, 0, ao[0])
                    v1 = to_uint(x + 1, y + 1, z,     voxel_id, 0, ao[1])
                    v2 = to_uint(x + 1, y + 1, z + 1, voxel_id, 0, ao[2])
                    v3 = to_uint(x,     y + 1, z + 1, voxel_id, 0, ao[3])
                ...
                if is_void((x, y - 1, z), (wx, wy - 1, wz), world_voxels):
                    ...
                    v0 = to_uint(x,     y, z,     voxel_id, 1, ao[0])
                    v1 = to_uint(x + 1, y, z,     voxel_id, 1, ao[1])
                    v2 = to_uint(x + 1, y, z + 1, voxel_id, 1, ao[2])
                    v3 = to_uint(x,     y, z + 1, voxel_id, 1, ao[3])
                    if flip_id:
                ...
                if is_void((x + 1, y, z), (wx + 1, wy, wz), world_voxels):
                    ...
                    v0 = to_uint(x + 1, y,     z,     voxel_id, 2, ao[0])
                    v1 = to_uint(x + 1, y + 1, z,     voxel_id, 2, ao[1])
                    v2 = to_uint(x + 1, y + 1, z + 1, voxel_id, 2, ao[2])
                    v3 = to_uint(x + 1, y,     z + 1, voxel_id, 2, ao[3])
                ...
                if is_void((x - 1, y, z), (wx - 1, wy, wz), world_voxels):
                    ...
                    v0 = to_uint(x, y, z, voxel_id, 3, ao[0])
                    v1 = to_uint(x, y + 1, z, voxel_id, 3, ao[1])
                    v2 = to_uint(x, y + 1, z + 1, voxel_id, 3, ao[2])
                    v3 = to_uint(x, y, z + 1, voxel_id, 3, ao[3])
                ...
                if is_void((x, y, z - 1), (wx, wy, wz - 1), world_voxels):
                    ...
                    v0 = to_uint(x, y, z, voxel_id, 4, ao[0])
                    v1 = to_uint(x, y + 1, z, voxel_id, 4, ao[1])
                    v2 = to_uint(x + 1, y + 1, z, voxel_id, 4, ao[2])
                    v3 = to_uint(x + 1, y, z, voxel_id, 4, ao[3])
                ...
                if is_void((x, y, z + 1), (wx, wy, wz + 1), world_voxels):
                    ...
                    v0 = to_uint(x, y, z + 1, voxel_id, 5, ao[0])
                    v1 = to_uint(x, y + 1, z + 1, voxel_id, 5, ao[1])
                    v2 = to_uint(x + 1, y + 1, z + 1, voxel_id, 5, ao[2])
                    v3 = to_uint(x + 1, y, z + 1, voxel_id, 5, ao[3])
